...
<main class="row col-12 mb-5" style="min-height: 500px;">
	<div class="col"></div>
		...
		<div class="mb-3 d-flex .flex-lg-row mt-2 col-3 ">
			<form action="" method="GET" class="">
				...
				<div class="d-flex">
					...
					<button type="submit" class="btn btn-primary mt-2 m-2">GO!</button>
				</div>
			</form>
		</div>
								...
								<div class="col-6">
									<div class="form-check">
										<input class="form-check-input" checked="true" type="radio"
											value="achats" onchange="change(event)" name="type"
											id="achats"> <label class="form-check-label"
											for="achats"> Achats </label>
									</div>
									<div class="container ck-achats">
										<div class="form-check">
											<input class="form-check-input" name="eo" type="checkbox"
												value="eo" id="eo"> <label class="form-check-label"
												for="eo"> Enchères ouvertes </label>
										</div>
										<div class="form-check">
											<input class="form-check-input" type="checkbox" name="etat"
												value="EC" id="meec"> <label
												class="form-check-label" for="meec"> Mes enchères en
												cours </label>
										</div>
										<div class="form-check">
											<input class="form-check-input" type="checkbox" name="etat"
												value="ET" id="mer"> <label class="form-check-label"
								...
								<div class="col-6">
									<div class="form-check">
										<input class="form-check-input" type="radio" name="type"
											value="vente" id="mes_ventes" onchange="change(event)">
										<label class="form-check-label" for="mes_ventes"> Mes
											ventes </label>
									</div>
									<div class="container ck-ventes">
										<div class="form-check">
											<input name="mvec" class="form-check-input" disabled
												type="checkbox" id="mvec"> <label
												class="form-check-label" for="mvec"> Mes vente en
												cours </label>
										</div>
										<div class="form-check">
											<input class="form-check-input" disabled type="checkbox"
												value="EA" name="vnd" id="vnd"> <label class="form-check-label"
												for="vnd"> ventes non débutées </label>
										</div>
										<div class="form-check">
											<input class="form-check-input" disabled type="checkbox"
												value="ET" name="mvt" id="vt"> <label class="form-check-label"
												for="vt"> ventes terminées </label>
										</div>
									</div>
								</div>
							</div>
